...
using CustomAbpProject.Models.TokenAuth;
...
{
    public abstract class CustomAbpProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CustomAbpProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CustomAbpProjectWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<CustomAbpProjectDbContext> action)
        {
            using (var context = IocManager.Resolve<CustomAbpProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<CustomAbpProjectDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<CustomAbpProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CustomAbpProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CustomAbpProjectDbContext, Task<T>> func)
        {
            T result;
